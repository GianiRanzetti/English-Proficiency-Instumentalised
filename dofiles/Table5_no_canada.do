...
// Drops all Canadian observations
keep if bpld~=15000
...
esttab marriedpresent_tab5 divorced_tab5 evermarried_tab5 share_bpld_minusself_tab5 abovemean_bpld2_tab5 ancestpct_minusself_tab5 abovemean_ancestry2_tab5 using  "$output/Table5/Table5_no_canada.csv", keep(eng) replace
